...
export default function Head() {
  return (
    <main className="w-full max-w-screen-xl mx-auto bg-[#2A254B] px-6 py-4 flex justify-between items-center"> {/* Limited container width and adjusted padding */}
      {/* Left side */}
      <div className="flex flex-col justify-start w-[60%] space-y-6"> {/* Adjusted width of the text */}
